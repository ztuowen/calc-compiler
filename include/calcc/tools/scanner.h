...
namespace calcc {
  namespace tools {
    ...
    protected:
      ...
      virtual ast::Expr *scan(ast::VScope *e, T &out) {
        run(e->getExpr(), out);
        return e;
      }
    ...
    public:
      virtual ast::Expr *run(ast::Expr *e, T &out) {
        ...
        switch (e->getExprType()) {
          case ast::EXPR_INT:
            return scan(static_cast<ast::IntLiteral *>(e), out);
          case ast::EXPR_REF:
            return scan(static_cast<ast::Ref *>(e), out);
          case ast::EXPR_IF:
            return scan(static_cast<ast::If *>(e), out);
          case ast::EXPR_BINOP:
            return scan(static_cast<ast::BinaryOp *>(e), out);
          case ast::EXPR_VDECL:
            return scan(static_cast<ast::VDecl *>(e), out);
          case ast::EXPR_FDECL:
            return scan(static_cast<ast::FDecl *>(e), out);
          case ast::EXPR_VALP:
            return scan(static_cast<ast::ValPtr *>(e), out);
          case ast::EXPR_SET:
            return scan(static_cast<ast::Set *>(e), out);
          case ast::EXPR_SEQ:
            return scan(static_cast<ast::Seq *>(e), out);
          case ast::EXPR_WHILE:
            return scan(static_cast<ast::While *>(e), out);
          case ast::EXPR_VSCO:
            return scan(static_cast<ast::VScope *>(e), out);
          default:
            throw error::scanner("Unknown node type");
        }
      }
    };
  }
